...
class App extends React.Component {
    constructor () {
        ...
        this.state = {
            ...
            thumbnail: 'http://irsl.ss.ncu.edu.tw/media/product/Infrasound/real_inf.png',
    ...
    setSrc = (diffTime) => {
        this.setState({
            ...
            thumbnail: this.getINF(moment().subtract(-5+moment().utcOffset()/60,'hours').subtract(diffTime,'days').startOf('hour')),
            diffTime: diffTime
        });
    }
            ...
            <div className='container'>
                <div className='row'>
                    <div className="col-lg-7 col-md-12 ml-auto mr-auto mt-1 text-left">
                        ...
                        {this.state.isOpen && (
                              <Lightbox
                                  mainSrc={this.getINF(this.state.mainDate)}
                                  nextSrc={this.getINF(this.state.nextDate)}
                                  prevSrc={this.getINF(this.state.prevDate)}
                    ...
                    <div className="col-lg-5 col-md-12 text-center d-flex align-items-end pt-4">
                        <img className="w-100" src="http://www2.ss.ncu.edu.tw/~istep/images/infrasound_station.png" alt=""/>
                    </div>
                </div>
            </div>
        )
